        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-black mb-10 leading-relaxed">
              From high-performance structural foundations to artisan decorative finishes, Clayton Concrete provides the technical expertise and local experience required for excellence in the Triangle region.
            </p>
          </div>
        </div>
      </header>
            ...
            {[
              ...
              <div key={service.slug} className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm">
                ...
                <ul className="grid grid-cols-2 gap-4">
                  {['Garner', 'Raleigh', 'Selma', 'Cary', 'Smithfield'].map((city) => (
                    <li key={city}>
                      <Link 
      ...
      <section className="py-24 bg-black overflow-hidden relative">
        <div className="max-w-[1600px] mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Contact Clayton's leading concrete team for a detailed consultation and professional estimate.
          </p>
