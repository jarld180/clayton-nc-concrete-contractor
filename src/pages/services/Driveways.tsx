        ...
        <section className="max-w-7xl mx-auto px-8 py-32 grid lg:grid-cols-3 gap-32">
          <div className="lg:col-span-2 space-y-16 text-black">
            ...
            <p className="text-lg text-black font-light leading-relaxed text-justify">
              Every driveway we install in Clayton is a masterpiece of geotechnical engineering. We begin with a deep analysis of the local East NC soil, which is notorious for its high clay content and expansive nature. Standard concrete pours often fail within a few years due to the "shrink-swell" cycles of this clay. Our solution involves a multi-layered approach: deep excavation, a 6-inch compacted ABC stone base, and a high-density concrete mix reinforced with both grade-60 steel rebar and synthetic fibers. This ensures that your driveway doesn't just look good on day one—it remains a structural asset for your property for the next 40 to 50 years.
            </p>
            <div className="space-y-8">
              <h3 className="text-2xl font-bold italic">The Art of the Finish</h3>
              <p className="text-lg text-black font-light leading-relaxed text-justify">
                Beyond the structural integrity, we focus on the aesthetic value of your home. A driveway is the literal red carpet to your residence. We offer signature "picture frame" borders that provide a sophisticated, architectural look. Our broom finishes are applied with precise timing to ensure maximum slip resistance without sacrificing the clean, uniform appearance that high-end homes in neighborhoods like Covered Bridge and Flowers Plantation demand. We manage all aspects of the project, from initial grading and local Clayton permitting to the final high-solids solvent sealing that protects your investment from oil spills, UV damage, and the intense humidity of NC summers.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div data-aos="fade-right">
              <span className="inline-block px-4 py-1.5 bg-white rounded-full text-sm font-bold tracking-wider uppercase text-black mb-6 border border-gray-200">Clayton, NC Driveway Specialists</span>
              ...
              <p className="text-xl text-black mb-10 leading-relaxed text-justify">
                Your driveway is the first impression your property makes. At Clayton Concrete Contractor, we don't just pour concrete; we build reinforced, architecturally significant entryways designed to handle heavy loads, extreme NC weather, and the test of time.
              </p>
            ...
            <div className="relative" data-aos="fade-left">
              <img src="/services/driveways/option 1.webp" alt="Custom Concrete Driveway Clayton NC" className="rounded-[40px] shadow-2xl w-full h-[500px] object-cover border-8 border-white" />
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2">
              <div className="prose prose-xl prose-slate max-w-none text-black">
                ...
                <p className="text-lg leading-relaxed text-black mb-8 text-justify">
                  A driveway should complement your home's architecture. We offer several signature finishes that are popular in Clayton's premier neighborhoods:
                </p>
                <ul className="space-y-6 my-12">
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-black">Essential for Clayton's hilly terrain. Our specialized brooming technique provides maximum traction for vehicles during wet or icy NC conditions while maintaining a beautiful, uniform texture.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <Star className="w-6 h-6 text-black shrink-0 mt-1" />
                ...
                <h3 className="text-3xl font-bold text-black mb-6 mt-16 text-justify">Why Choose Clayton Concrete Contractor?</h3>
                <p className="text-lg leading-relaxed text-black mb-12 text-justify">
                  We are a locally owned and operated team that understands Clayton's building codes and neighborhood standards better than anyone. We handle the entire permitting process with the City of Clayton and Clayton County, including all 811 utility locates and mandatory inspections. Our crews are uniformed, professional, and we maintain a clean job site from day one to final walkthrough. When you choose us, you are choosing a partner dedicated to adding permanent value to your home.
                </p>
              </div>
            </div>
                ...
                <div className="mt-12 space-y-8 p-8 bg-gray-50 rounded-[40px] border border-gray-100">
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <p className="text-sm leading-relaxed text-justify"><strong>Clayton Clay:</strong> We excavate deeper than our competitors to ensure the expansive red clay doesn't buckle your new driveway.</p>
                    </div>
                    <div className="flex gap-4">
                    ...
                    <div className="flex gap-4">
                      ...
                      <p className="text-sm leading-relaxed text-justify"><strong>Clayton Permits:</strong> We handle all city and county documentation to ensure your project is 100% compliant.</p>
                    </div>
                  </div>
                </div>
              </div>
