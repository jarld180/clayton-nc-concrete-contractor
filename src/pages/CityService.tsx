...
const CityService: React.FC = () => {
  ...
  const contentData: Record<string, any> = {
    'mint-hill-driveways': {
      heroDesc: `Premium concrete driveway installation and replacement for Garner homeowners. Engineered for the heavy Piedmont clay soils of Johnston County.`,
      articleTitle: `Mastering Driveway Construction in Garner`,
      articleText: `A driveway in Garner is more than just a place to park; it's a critical component of your property's structural integrity. Near the historic downtown and newer developments, the soil requires expert-level stabilization. We utilize a 6-inch compacted ABC stone base and high-density fiber-reinforced concrete to ensure your driveway lasts for decades without the common cracking seen in standard pours.`,
      features: [
        { title: "Clay Soil Stabilization", desc: "Deep excavation and engineered stone base to prevent shrink-swell cracking." },
        { title: "Neighborhood Matching", desc: "Artisan finishes that complement the unique aesthetic of Garner." },
        { title: "Precision Grading", desc: "Laser-leveled slope management to protect your home's foundation from runoff." }
      ],
      reviews: [
        { text: "They replaced our long driveway in Garner. The crew was professional and the finish is flawless.", author: "Michael R., Garner, NC" },
        { text: "Best concrete work we've seen in the area. They matched our existing walkway perfectly.", author: "Sarah W., Garner, NC" }
      ],
    ...
    'weddington-patios': {
      heroDesc: `Luxury artisan stamped patios for Smithfield estates. High-end decorative finishes designed for ultimate outdoor living.`,
      articleTitle: `High-Performance Patios for Smithfield Living`,
      articleText: `Estate living in Smithfield demands a higher standard of concrete artistry. Our stamped patios utilize UV-stable pigments and high-solids solvent sealers to prevent the fading and wear common in large-scale outdoor projects. Whether you're in Riverwood or Hemby Bridge, our heat-reflective technology options keep surfaces comfortable, making your outdoor oasis the centerpiece of your property.`,
      features: [
      ...
      reviews: [
        { text: "Our new patio in Smithfield is amazing. The detail in the stamping is incredible.", author: "Jennifer L., Smithfield, NC" },
        { text: "Professional team. They handled our large-scale project with absolute precision.", author: "Robert P., Smithfield, NC" }
      ],
      mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3268.8!2d-80.7328!3d35.0107!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x885428088888888b%3A0x885428088888888b!2sSmithfield%2C%20NC!5e0!3m2!1sen!2sus!4v1704576000000!5m2!1sen!2sus"
    }
  };
