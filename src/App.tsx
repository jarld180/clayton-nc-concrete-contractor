          ...
          <div className="flex flex-col min-h-screen font-inter text-black">
            ...
            <main className="flex-grow">
              <Routes>
                ...
                <Route path="/garner" element={<Home cityName="Garner" />} />
                <Route path="/raleigh" element={<Home cityName="Raleigh" />} />
                <Route path="/selma" element={<Home cityName="Selma" />} />
                <Route path="/cary" element={<Home cityName="Cary" />} />
                <Route path="/smithfield" element={<Home cityName="Smithfield" />} />
